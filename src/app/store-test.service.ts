...
export class StoreTestService {
  ...
  forNewBlog = [
    { image: 'https://via.placeholder.com/560x380?text=Visit', subtitle: 'Blog Post',
  ...
  forNews = [
    {image: 'https://via.placeholder.com/250x250?text=Visit', titl: 'Announcing V2.9.7 Release',
    ...
    {image: 'https://via.placeholder.com/250x250?text=Visit', titl: 'Doing Wonders With Images In the Froala',
    ...
    {image: 'https://via.placeholder.com/250x250?text=Visit', titl: 'Quick and Easy Methods to Adjust the Size of Your Froala',
    ...
    {image: 'https://via.placeholder.com/250x250?text=Visit', titl: 'Using Multiple Froala Editors On a Single Webpage',
    ...
    {image: 'https://via.placeholder.com/250x250?text=Visit', titl: '3 Easy Steps to Designing Impressive Email Templates with Froala',
  ...
  forContinue = [
    {image: 'https://via.placeholder.com/250x360?text=Visit', titl: 'Ready to continue your video marketing journey?',
  ...
  forErik = [
    {image: 'https://via.placeholder.com/80x80?text=Erik', name: 'Erik Mathes',
